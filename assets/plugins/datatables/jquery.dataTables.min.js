...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Birinji",sLast:"Soňky",sNext:"Indiki",sPrevious:"Yzky"},sEmptyTable:"Tablisada maglumat tapylmady",sInfo:"_START_-dan/den _END_-e/ä çenli. Jemi: _TOTAL_ setir",sInfoEmpty:"Hiç hili maglumat ýok",
sInfoFiltered:"(Ähli setirlerde _MAX_ setir filtrlendi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ setirleri görkez",sLoadingRecords:"Ýüklenýär...",sProcessing:"Garaşyň...",sSearch:"Gözleg:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Dogry gelýän maglumat tapylmady"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
