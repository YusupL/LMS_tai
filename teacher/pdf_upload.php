...
if (isset($_POST['submit'])){
    ...
    if (isset($_FILES['pdffile']) && $_FILES['pdffile']['error'] === UPLOAD_ERR_OK)
      {
        ...
        // sanitize file-name
        $newFileName = $aralyk_jemleme."_".$id_dersler[0].'.'.$fileExtension;
    ...
    for ($i=1; $i<$count_id_d; $i++){
        $file='pdfler/'.$aralyk_jemleme."_".$id_dersler[0].'.pdf';
        $newfile='pdfler/'.$aralyk_jemleme."_".$id_dersler[$i].'.pdf';
        copy($file, $newfile);
    }
?> 
