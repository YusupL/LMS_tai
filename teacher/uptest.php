        ...
        <div class="container-fluid">
                    ...
                    <div class="card" style="margin: 15px; background-color: #EAECEE; box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        ...
                        <div id="sapak<?php echo $ders_id; ?>" class="panel-collapse collapse">
                            <div class="panel-body">  
                                <form class="" method="post" action="general.php" enctype="multipart/form-data">
                                    ...
                                    <div class='form-group row'>
                                        <div class="col-md-8">
                                            ...
                                            ?>                                                      
                                                ...
                                                <?php }
                                            ?>
                                        <div class='col-md-4'> <input type='submit' name='submit' class='btn btn-success class_pdf' value='Test goşmak' <?php if ($sorsan>=$adaty_ss) echo "disabled"; ?>></div>
                                    </div>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <div class='form-group row'>
                                        <div class="col-md-8">
                                            ...
                                            ?>                                                      
                                                ...
                                                <?php }
                                            ?>
                                        <div class='col-md-4'> <input type='submit' name='submit' class='btn btn-success class_pdf' value='Test goşmak' <?php if ($sorsan>=$bakalawr_ss) echo "disabled"; ?>></div>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <?php
                ...
                if ($totalrows>0){                    
                    ...
                    <div class="card" style="margin: 15px; background-color: #EAECEE; box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        <div class="card-header" style="background-color: #FCF5BA;">
                            <h3 class="card-title bg-primary text-white" style="background-color: #32ce36; font-family: Georgia; padding: 7px;">Dil öwreniş bölümi üçin</h3>
                        </div>
                                    ...
                                    <div class='form-group row'>
                                        <div class="col-md-3">
                                            ...
                                            ?>                                                      
                                                ...
                                                <?php }
                                            ?>
                                        <div class='col-md-3'> <input type='submit' name='submit' class='btn btn-success class_pdf' value='Test goşmak' <?php if ($sorsan>=$pod_ss) echo "disabled"; ?>></div>
                                    </div>
                                </form>
                            </div>
                        </div>
